...
<section>
    ...
    <form id="form1" runat="server" defaultfocus="txtEmail1" defaultbutton="btnCheckOut">
        ...
        <asp:TextBox ID="txtPhone" runat="server" CssClass="entry"  Text="99999-99999"></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="revPhone" runat="server" 
                ...
                ValidationExpression="((\(\d{5}\) ?)|(\d{5}-))?\d{5}" 
                ControlToValidate="txtPhone">Use this format:99999 or 999999-99999</asp:RegularExpressionValidator><br />
        <label>Day of Birth:</label>
        <asp:TextBox ID="txtDayofBirth" runat="server" CssClass="entry" Text="dd/mm/yyyy"></asp:TextBox>
        <asp:RegularExpressionValidator ID="revDayofBirth" runat="server"
            CssClass="validator" Display="Dynamic" ErrorMessage="Day of Birth"
            ValidationExpression ="[01]?\d\/[0-3]\d\/\d{4}"
            ControlToValidate="txtDayofBirth">Use this format:dd/mm/yyyy</asp:RegularExpressionValidator><br/>
